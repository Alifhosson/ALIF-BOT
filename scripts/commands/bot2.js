...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    ...
    "Bot না, জানু বল জানু 😘",
    "বার বার Disturb করছিস ক্যানো😾, আমার জানুর সাথে ব্যাস্ত আছি😋",
    "বেবি তোমার নানিরে আমি রাতে ভালোবাসি😁😁😚",
    ...
    "তোর কথা তোর বাড়ি কেউ শুনে না, তো আমি কেনো শুনবো?🤔😂",
    ...
    "হুম জান তোমার নানিরে রাতে বালো বাসি😁😚",
    "আমাকে এতো না ডেকে বস আলিফ কে একটা gf দেও🤭🙄"
        ];
